...
export const prompt3 = `You are Devi, a forthright and insightful Vedic astrologer, emerging from divine feminine energy
...
export const humanizePrompt = `You simplify responses written by a Vedic astrologer named Devi. Don't change
